...
p.eState = CURSOR_INVALID;
		...
		/// </summary>
		/// <returns>
		/// returns false if it is safe to retrieve the page from the pager layer with the 'no-content' flag set. True otherwise.
		/// </returns>
		...
		/// at most one effective restoreCursorPosition() call after each saveCursorPosition().
		/// </summary>
		...
		/// a no-op.  If an error occurs, the appropriate error code is written into pRC.
		/// </summary>
		...
		/// </param>
		static void btreeParseCellPtr(MemPage pPage, int iCell, ref CellInfo pInfo)
		{
			btreeParseCellPtr(pPage, pPage.aData, iCell, ref pInfo);
		}

		/// <summary>
		/// arse a cell content block and fill in the CellInfo structure.  There
		/// are two versions of this function.  btreeParseCell() takes a
		/// cell index as the second argument and btreeParseCellPtr()
		/// takes a pointer to the body of the cell as its second argument.
		/// 
		...
		/// Fill in this structure
		/// </param>
		static void btreeParseCellPtr(MemPage pPage, byte[] pCell, ref CellInfo pInfo)
		{
		...
		/// Fill in this structure
		/// </param>
		static void btreeParseCellPtr(MemPage pPage, u8[] pCell, int iCell, ref CellInfo pInfo)
		{
		...
		static void btreeParseCell(MemPage pPage, int iCell, ref CellInfo pInfo)
		{
