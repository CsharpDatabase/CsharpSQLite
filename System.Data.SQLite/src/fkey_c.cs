...
*/
		...
		*/
		...
		/// </param>
		/// <param name='ppIdx'>
		/// Unique index on parent table
		/// </param>
		/// <param name='paiCol'>
		/// Map of index columns in pFKey
		/// </param>
		static int locateFkeyIndex(Parse pParse, Table pParent, FKey pFKey, out Index ppIdx, out int[] paiCol)
		{
