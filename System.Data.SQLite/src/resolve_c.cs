...
namespace System.Data.SQLite
{
	...
	public partial class Sqlite3
	{
		...
		*/
		...
		/// "GROUP" or "ORDER" or "" 
		/// </param>
		static void resolveAlias(Parse pParse, ExprList pEList, int iCol, Expr pExpr, string zType)
		{
		...
		/// </param>
		static int lookupName(Parse pParse, string zDb, string zTab, string zCol, NameContext pNC, Expr pExpr)
		{
...
return WRC_Prune;
		...
		/// </param>
		static void resolveOutOfRangeError(Parse pParse, string zType, int i, int mx)
		{
		...
		*/
		...
		/// </param>
		static int sqlite3ResolveExprNames(NameContext pNC, ref Expr pExpr)
		{
			u8 savedHasAgg;
			Walker w = new Walker();
